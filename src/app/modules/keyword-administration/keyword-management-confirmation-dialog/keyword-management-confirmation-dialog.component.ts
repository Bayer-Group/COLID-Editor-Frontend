...
import { KeywordGraphUpdateDto } from "src/app/shared/models/keyword-management/keyword-graph-update-dto";
...
@Component({
  ...
  styleUrls: ["./keyword-management-confirmation-dialog.component.css"],
})
