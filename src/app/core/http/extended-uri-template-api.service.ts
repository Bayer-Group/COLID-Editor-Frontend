...
export class ExtendedUriTemplateApiService extends EntityBaseApiService<ExtendedUriTemplateRequestDTO, ExtendedUriTemplateResultDTO, ExtendedUriTemplateWriteResultCTO> {

  public controllerRouteSingle = 'extendedUriTemplate';
  public controllerRoutePlural = 'extendedUriTemplateList';
