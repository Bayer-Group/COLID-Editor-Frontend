...
export class PidUriTemplateApiService extends EntityBaseApiService<PidUriTemplateRequestDTO, PidUriTemplateResultDTO, PidUriTemplateWriteResultCTO> {

  public controllerRouteSingle = 'pidUriTemplate';
  public controllerRoutePlural = 'pidUriTemplateList';
