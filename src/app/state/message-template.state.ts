...
export class MessageTemplateState {
    ...
    UpdateMessageTemplate(ctx: StateContext<MessageTemplateStateModel>, action: UpdateMessageTemplate) {
        return this.messageTemplateApiService.updateMessageTemplate(action.str).pipe(tap((res: MessageTemplate) => {
            ctx.patchState({
    ...
    FetchMessageTemplates({ patchState }: StateContext<MessageTemplateStateModel>, { }: FetchMessageTemplates) {
        return this.messageTemplateApiService.getMessageTemplates().pipe(tap((res: MessageTemplate[]) => {
            patchState({
                messageTemplates: res
            });
        }));
