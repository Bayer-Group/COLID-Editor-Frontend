...
export class FetchExtendedUriTemplateMetadata {
    static readonly type = '[ExtendedUriTemplate] Fetch extendedUriTemplateMetadata';
    constructor() {}
}
...
export class EditExtendedUriTemplate {
    ...
    constructor(public id: string, public payload: ExtendedUriTemplateRequestDTO) { }
}
...
export class ExtendedUriTemplateState {
    ...
    @Selector()
    public static getExtendedUriTemplateMetadata(state: ExtendedUriTemplateStateModel) {
        return state.metadata;
    }

    @Action(FetchExtendedUriTemplates)
    fetchExtendedUriTemplates({ getState, patchState }: StateContext<ExtendedUriTemplateStateModel>, { }: FetchExtendedUriTemplates) {
        return this.extendedUriTemplateApiService.getAllEntities().pipe(tap(res => {
            patchState({
    ...
    fetchExtendedUriTemplateMetadata({ getState, patchState }: StateContext<ExtendedUriTemplateStateModel>, { }: FetchExtendedUriTemplateMetadata) {
        if (getState().metadata != null) { return; }

        return this.metadataService.getMetaData(Constants.ResourceTypes.ExtendedUriTemplate).pipe(tap(res => {
            patchState({
                metadata: res
            });
        }));
    ...
    createExtendedUriTemplate({ getState, patchState, dispatch }: StateContext<ExtendedUriTemplateStateModel>, { payload }: CreateExtendedUriTemplate) {
        return this.extendedUriTemplateApiService.createEntity(payload)
            .pipe(
                mergeMap(() => dispatch(new FetchExtendedUriTemplates()))
            );
    }

    @Action(DeleteExtendedUriTemplate)
    deleteExtendedUriTemplate({ getState, patchState, dispatch }: StateContext<ExtendedUriTemplateStateModel>, { payload }: DeleteExtendedUriTemplate) {
        return this.extendedUriTemplateApiService.deleteEntity(payload).pipe(
            mergeMap(() => dispatch(new FetchExtendedUriTemplates()))
        );
    }

    @Action(EditExtendedUriTemplate)
    editExtendedUriTemplate({ getState, patchState, dispatch }: StateContext<ExtendedUriTemplateStateModel>, { id, payload }: EditExtendedUriTemplate) {
        return this.extendedUriTemplateApiService.editEntity(id, payload)
            .pipe(
                mergeMap(() => dispatch(new FetchExtendedUriTemplates()))
            );
    }
    ...
    fetchExtendedUriTemplateDetails({ getState, patchState }: StateContext<ExtendedUriTemplateStateModel>, { payload }: FetchExtendedUriTemplateDetails) {
        return this.extendedUriTemplateApiService.getEntityById(payload).pipe(tap(res => {
            patchState({
    ...
    clearExtendedUriTemplate({ getState, patchState }: StateContext<ExtendedUriTemplateStateModel>, {  }: ClearExtendedUriTemplate) {
        patchState({
            extendedUriTemplate: null
        });
    }
