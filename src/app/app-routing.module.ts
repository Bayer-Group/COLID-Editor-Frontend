...
const helpRoute: Route = { path: "help", component: ResourceHelpComponent };
...
const adminRoute: Route = {
  ...
  children: [
    ...
    },
    {
      path: "graph",
      loadChildren: () =>
        import("./modules/graph-management/graph-management.module").then(
          (m) => m.GraphManagementModule
        ),
      canActivate: [AuthGuardSuperAdminService],
    },
    {
    ...
    { path: "assignuser", component: AssignUserComponent },
    {
      ...
      loadChildren: () =>
        import("./modules/deletion-request/deletion-request.module").then(
    ...
    },
    {
      ...
      loadChildren: () =>
        import("./modules/identifier/identifier.module").then(
          (m) => m.IdentifierModule
        ),
      canActivate: [AuthGuardSuperAdminService],
    },
    {
...
const systemAnalytics = {
  path: "systemanalytics",
  loadChildren: () =>
    import("./modules/system-analytics/system-analytics.module").then(
      (m) => m.SystemAnalyticsModule
    ),
};
