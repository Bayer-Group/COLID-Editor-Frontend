...
import { ResourceState, FetchResourceRevisionHistory } from 'src/app/state/resource.state';
import { Select, Store } from '@ngxs/store';
import { Observable } from 'rxjs';
import { FetchMetadata, MetaDataState } from 'src/app/state/meta-data.state';
...
export class ResourceHistoryComponent implements OnInit {
  @Select(ResourceState.getResourceRevisionHistory) history$: Observable<Array<ResourcRevisionHistory>>;
  ...
  handleSelectionChanged(event: ResourcRevisionHistory) {
