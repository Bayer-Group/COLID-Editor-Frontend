...
import { ExtendedUriTemplateState, FetchExtendedUriTemplateMetadata } from 'src/app/state/extended-uri-template.state';
...
export class ExtendedUriTemplateComponent implements OnInit {
  @Select(ExtendedUriTemplateState.getExtendedUriTemplateMetadata) extendedUriTemplateMetadata$: Observable<Array<MetaDataProperty>>;
