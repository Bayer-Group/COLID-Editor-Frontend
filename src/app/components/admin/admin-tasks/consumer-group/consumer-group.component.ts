...
import { ConsumerGroupState, FetchConsumerGroupMetadata } from 'src/app/state/consumer-group.state';
...
export class ConsumerGroupComponent implements OnInit {
  @Select(ConsumerGroupState.getConsumerGroupMetadata) consumerGroupMetadata$: Observable<Array<MetaDataProperty>>;
